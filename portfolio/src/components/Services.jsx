...
export default function Services() {
  return (
    <section className='mt-[120px]' >
        ...
        {/* body  */}
        <div className='grid grid-cols-12 mt-16 font-mulish' >
            {/* services  */}
               ...
               <div className='space-y-16'>
                 ...
                 {servicesData.map((service,index)=>(
                    <div className='space-y-4'>
                        ...
                        <p  className='w-7/12 opacity-70' >{service.para}</p>
                    </div>
                ))}
               </div>
            </div>
            ...
            {/* video  */}
            <div className=' col-span-4 flex justify-center rounded-[30px] items-center h-[500px] bg-[#D0D8E7]' >
