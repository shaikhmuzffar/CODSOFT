...
import servicesMobileImg from '../assets/servicesMobileImg.png'
...
export default function Services() {
  return (
    <section className='mt-[120px]' >
        ...
        {/* body  */}
        <div className='grid grid-cols-12 mt-[90px] gap-y-[60px] sm:gap-y-[90px] md:gap-y-[90px] md:mt-16 font-mulish' >
            {/* services  */}
               ...
               <div className='space-y-12 md:space-y-16'>
                 ...
                 {servicesData.map((service,index)=>(
                    <div className='space-y-4'>
                        ...
                        <p  className='w-10/12 leading-7 md:w-9/12 line-clamp-3 sm:line-clamp-2 lg:w-10/12 opacity-70' >{service.para}</p>
                    </div>
                ))}
               </div>
            </div>
            ...
            <div className='col-span-12  md:col-span-7 ' >
                <img src={servicesImg} className='h-[350px] sm:h-[400px] hidden md:block  md:h-[600px] w-full object-contain' alt="" />
                <img src={servicesMobileImg} className='h-[350px] sm:h-[400px]  md:hidden  md:h-[600px] w-full object-contain' alt="" />
            </div>
