                    ...
                    {blogData.map(({ color, status, title, para, tags,image }) => (
                        <div className='grid grid-cols-12 '>
                            ...
                            <div className='col-span-5 pr-7'>
                                <div className='space-y-5'>
                                    ...
                                    <div className='space-y-3'>
                                        <h1 className='text-2xl font-bold opacity-90 leading-[40px]' >{title}</h1>
                                        <p className='text-xl opacity-90'> {tags.join(' ꞏ ')}</p>
                                        <p className='text-sm opacity-70 leading-7'>{para.slice(0, 170) + "..."}</p>
                                    </div>
                            ...
                            <div className='col-span-5  '>
                                <img src={image} alt={title} className='h-[300px] rounded-2xl w-full object-cover' />
                            </div>
                        </div>
                    ))}
                </div>
