  ...
  return (
    <section className='font-mulish' >
      <div className='grid grid-cols-12 space-y-5 md:space-y-0' >
        <p className='col-span-12 md:col-span-5  text-xl font-[800] text-myPurple '>{subTitle}</p>
        {
            title &&
        <div className='col-span-12 md:col-span-7 space-y-5 md:space-y-0 text-textBlack'>
